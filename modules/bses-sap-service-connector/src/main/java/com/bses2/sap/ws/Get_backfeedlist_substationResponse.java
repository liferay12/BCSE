...
public class Get_backfeedlist_substationResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.Get_backfeedlist_substationResponseGet_backfeedlist_substationResult get_backfeedlist_substationResult;

    public Get_backfeedlist_substationResponse() {
    }

    public Get_backfeedlist_substationResponse(
           com.bses2.sap.ws.Get_backfeedlist_substationResponseGet_backfeedlist_substationResult get_backfeedlist_substationResult) {
     ...
     */
    public com.bses2.sap.ws.Get_backfeedlist_substationResponseGet_backfeedlist_substationResult getGet_backfeedlist_substationResult() {
        return get_backfeedlist_substationResult;
    }
     ...
     */
    public void setGet_backfeedlist_substationResult(com.bses2.sap.ws.Get_backfeedlist_substationResponseGet_backfeedlist_substationResult get_backfeedlist_substationResult) {
        this.get_backfeedlist_substationResult = get_backfeedlist_substationResult;
    }

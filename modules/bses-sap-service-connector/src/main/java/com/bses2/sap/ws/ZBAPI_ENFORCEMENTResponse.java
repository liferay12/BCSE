...
public class ZBAPI_ENFORCEMENTResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_ENFORCEMENTResponseZBAPI_ENFORCEMENTResult ZBAPI_ENFORCEMENTResult;

    public ZBAPI_ENFORCEMENTResponse() {
    }

    public ZBAPI_ENFORCEMENTResponse(
           com.bses2.sap.ws.ZBAPI_ENFORCEMENTResponseZBAPI_ENFORCEMENTResult ZBAPI_ENFORCEMENTResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_ENFORCEMENTResponseZBAPI_ENFORCEMENTResult getZBAPI_ENFORCEMENTResult() {
        return ZBAPI_ENFORCEMENTResult;
    }
     ...
     */
    public void setZBAPI_ENFORCEMENTResult(com.bses2.sap.ws.ZBAPI_ENFORCEMENTResponseZBAPI_ENFORCEMENTResult ZBAPI_ENFORCEMENTResult) {
        this.ZBAPI_ENFORCEMENTResult = ZBAPI_ENFORCEMENTResult;
    }

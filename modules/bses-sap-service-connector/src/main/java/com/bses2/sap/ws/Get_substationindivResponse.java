...
public class Get_substationindivResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.Get_substationindivResponseGet_substationindivResult get_substationindivResult;

    public Get_substationindivResponse() {
    }

    public Get_substationindivResponse(
           com.bses2.sap.ws.Get_substationindivResponseGet_substationindivResult get_substationindivResult) {
     ...
     */
    public com.bses2.sap.ws.Get_substationindivResponseGet_substationindivResult getGet_substationindivResult() {
        return get_substationindivResult;
    }
     ...
     */
    public void setGet_substationindivResult(com.bses2.sap.ws.Get_substationindivResponseGet_substationindivResult get_substationindivResult) {
        this.get_substationindivResult = get_substationindivResult;
    }

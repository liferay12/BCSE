...
public class ZBAPI_BI_BAM09Response  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_BI_BAM09ResponseZBAPI_BI_BAM09Result ZBAPI_BI_BAM09Result;

    public ZBAPI_BI_BAM09Response() {
    }

    public ZBAPI_BI_BAM09Response(
           com.bses2.sap.ws.ZBAPI_BI_BAM09ResponseZBAPI_BI_BAM09Result ZBAPI_BI_BAM09Result) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_BI_BAM09ResponseZBAPI_BI_BAM09Result getZBAPI_BI_BAM09Result() {
        return ZBAPI_BI_BAM09Result;
    }
     ...
     */
    public void setZBAPI_BI_BAM09Result(com.bses2.sap.ws.ZBAPI_BI_BAM09ResponseZBAPI_BI_BAM09Result ZBAPI_BI_BAM09Result) {
        this.ZBAPI_BI_BAM09Result = ZBAPI_BI_BAM09Result;
    }

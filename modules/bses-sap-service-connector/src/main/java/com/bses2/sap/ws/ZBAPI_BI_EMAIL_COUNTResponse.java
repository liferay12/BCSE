...
public class ZBAPI_BI_EMAIL_COUNTResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_BI_EMAIL_COUNTResponseZBAPI_BI_EMAIL_COUNTResult ZBAPI_BI_EMAIL_COUNTResult;

    public ZBAPI_BI_EMAIL_COUNTResponse() {
    }

    public ZBAPI_BI_EMAIL_COUNTResponse(
           com.bses2.sap.ws.ZBAPI_BI_EMAIL_COUNTResponseZBAPI_BI_EMAIL_COUNTResult ZBAPI_BI_EMAIL_COUNTResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_BI_EMAIL_COUNTResponseZBAPI_BI_EMAIL_COUNTResult getZBAPI_BI_EMAIL_COUNTResult() {
        return ZBAPI_BI_EMAIL_COUNTResult;
    }
     ...
     */
    public void setZBAPI_BI_EMAIL_COUNTResult(com.bses2.sap.ws.ZBAPI_BI_EMAIL_COUNTResponseZBAPI_BI_EMAIL_COUNTResult ZBAPI_BI_EMAIL_COUNTResult) {
        this.ZBAPI_BI_EMAIL_COUNTResult = ZBAPI_BI_EMAIL_COUNTResult;
    }

...
public class GetfeedernameResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.GetfeedernameResponseGetfeedernameResult getfeedernameResult;

    public GetfeedernameResponse() {
    }

    public GetfeedernameResponse(
           com.bses2.sap.ws.GetfeedernameResponseGetfeedernameResult getfeedernameResult) {
     ...
     */
    public com.bses2.sap.ws.GetfeedernameResponseGetfeedernameResult getGetfeedernameResult() {
        return getfeedernameResult;
    }
     ...
     */
    public void setGetfeedernameResult(com.bses2.sap.ws.GetfeedernameResponseGetfeedernameResult getfeedernameResult) {
        this.getfeedernameResult = getfeedernameResult;
    }

...
public class ZBAPI_ZCS_CLI_WEBResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_ZCS_CLI_WEBResponseZBAPI_ZCS_CLI_WEBResult ZBAPI_ZCS_CLI_WEBResult;

    public ZBAPI_ZCS_CLI_WEBResponse() {
    }

    public ZBAPI_ZCS_CLI_WEBResponse(
           com.bses2.sap.ws.ZBAPI_ZCS_CLI_WEBResponseZBAPI_ZCS_CLI_WEBResult ZBAPI_ZCS_CLI_WEBResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_ZCS_CLI_WEBResponseZBAPI_ZCS_CLI_WEBResult getZBAPI_ZCS_CLI_WEBResult() {
        return ZBAPI_ZCS_CLI_WEBResult;
    }
     ...
     */
    public void setZBAPI_ZCS_CLI_WEBResult(com.bses2.sap.ws.ZBAPI_ZCS_CLI_WEBResponseZBAPI_ZCS_CLI_WEBResult ZBAPI_ZCS_CLI_WEBResult) {
        this.ZBAPI_ZCS_CLI_WEBResult = ZBAPI_ZCS_CLI_WEBResult;
    }

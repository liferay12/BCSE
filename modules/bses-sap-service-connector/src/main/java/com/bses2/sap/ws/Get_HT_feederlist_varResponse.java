...
public class Get_HT_feederlist_varResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.Get_HT_feederlist_varResponseGet_HT_feederlist_varResult get_HT_feederlist_varResult;

    public Get_HT_feederlist_varResponse() {
    }

    public Get_HT_feederlist_varResponse(
           com.bses2.sap.ws.Get_HT_feederlist_varResponseGet_HT_feederlist_varResult get_HT_feederlist_varResult) {
     ...
     */
    public com.bses2.sap.ws.Get_HT_feederlist_varResponseGet_HT_feederlist_varResult getGet_HT_feederlist_varResult() {
        return get_HT_feederlist_varResult;
    }
     ...
     */
    public void setGet_HT_feederlist_varResult(com.bses2.sap.ws.Get_HT_feederlist_varResponseGet_HT_feederlist_varResult get_HT_feederlist_varResult) {
        this.get_HT_feederlist_varResult = get_HT_feederlist_varResult;
    }

...
public class GetNearByComplaintCentersResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.GetNearByComplaintCentersResponseGetNearByComplaintCentersResult getNearByComplaintCentersResult;

    public GetNearByComplaintCentersResponse() {
    }

    public GetNearByComplaintCentersResponse(
           com.bses2.sap.ws.GetNearByComplaintCentersResponseGetNearByComplaintCentersResult getNearByComplaintCentersResult) {
     ...
     */
    public com.bses2.sap.ws.GetNearByComplaintCentersResponseGetNearByComplaintCentersResult getGetNearByComplaintCentersResult() {
        return getNearByComplaintCentersResult;
    }
     ...
     */
    public void setGetNearByComplaintCentersResult(com.bses2.sap.ws.GetNearByComplaintCentersResponseGetNearByComplaintCentersResult getNearByComplaintCentersResult) {
        this.getNearByComplaintCentersResult = getNearByComplaintCentersResult;
    }

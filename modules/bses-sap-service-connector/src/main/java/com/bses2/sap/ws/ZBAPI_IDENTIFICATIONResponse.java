...
public class ZBAPI_IDENTIFICATIONResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_IDENTIFICATIONResponseZBAPI_IDENTIFICATIONResult ZBAPI_IDENTIFICATIONResult;

    public ZBAPI_IDENTIFICATIONResponse() {
    }

    public ZBAPI_IDENTIFICATIONResponse(
           com.bses2.sap.ws.ZBAPI_IDENTIFICATIONResponseZBAPI_IDENTIFICATIONResult ZBAPI_IDENTIFICATIONResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_IDENTIFICATIONResponseZBAPI_IDENTIFICATIONResult getZBAPI_IDENTIFICATIONResult() {
        return ZBAPI_IDENTIFICATIONResult;
    }
     ...
     */
    public void setZBAPI_IDENTIFICATIONResult(com.bses2.sap.ws.ZBAPI_IDENTIFICATIONResponseZBAPI_IDENTIFICATIONResult ZBAPI_IDENTIFICATIONResult) {
        this.ZBAPI_IDENTIFICATIONResult = ZBAPI_IDENTIFICATIONResult;
    }

...
public class ZBAPI_DEMAND_NOTE_ONLINEResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_DEMAND_NOTE_ONLINEResponseZBAPI_DEMAND_NOTE_ONLINEResult ZBAPI_DEMAND_NOTE_ONLINEResult;

    public ZBAPI_DEMAND_NOTE_ONLINEResponse() {
    }

    public ZBAPI_DEMAND_NOTE_ONLINEResponse(
           com.bses2.sap.ws.ZBAPI_DEMAND_NOTE_ONLINEResponseZBAPI_DEMAND_NOTE_ONLINEResult ZBAPI_DEMAND_NOTE_ONLINEResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_DEMAND_NOTE_ONLINEResponseZBAPI_DEMAND_NOTE_ONLINEResult getZBAPI_DEMAND_NOTE_ONLINEResult() {
        return ZBAPI_DEMAND_NOTE_ONLINEResult;
    }
     ...
     */
    public void setZBAPI_DEMAND_NOTE_ONLINEResult(com.bses2.sap.ws.ZBAPI_DEMAND_NOTE_ONLINEResponseZBAPI_DEMAND_NOTE_ONLINEResult ZBAPI_DEMAND_NOTE_ONLINEResult) {
        this.ZBAPI_DEMAND_NOTE_ONLINEResult = ZBAPI_DEMAND_NOTE_ONLINEResult;
    }

...
public class ZBAPI_DSS_SOResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_DSS_SOResponseZBAPI_DSS_SOResult ZBAPI_DSS_SOResult;

    public ZBAPI_DSS_SOResponse() {
    }

    public ZBAPI_DSS_SOResponse(
           com.bses2.sap.ws.ZBAPI_DSS_SOResponseZBAPI_DSS_SOResult ZBAPI_DSS_SOResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_DSS_SOResponseZBAPI_DSS_SOResult getZBAPI_DSS_SOResult() {
        return ZBAPI_DSS_SOResult;
    }
     ...
     */
    public void setZBAPI_DSS_SOResult(com.bses2.sap.ws.ZBAPI_DSS_SOResponseZBAPI_DSS_SOResult ZBAPI_DSS_SOResult) {
        this.ZBAPI_DSS_SOResult = ZBAPI_DSS_SOResult;
    }

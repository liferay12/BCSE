...
public class ZBAPI_DSS_SO_ECCResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_DSS_SO_ECCResponseZBAPI_DSS_SO_ECCResult ZBAPI_DSS_SO_ECCResult;

    public ZBAPI_DSS_SO_ECCResponse() {
    }

    public ZBAPI_DSS_SO_ECCResponse(
           com.bses2.sap.ws.ZBAPI_DSS_SO_ECCResponseZBAPI_DSS_SO_ECCResult ZBAPI_DSS_SO_ECCResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_DSS_SO_ECCResponseZBAPI_DSS_SO_ECCResult getZBAPI_DSS_SO_ECCResult() {
        return ZBAPI_DSS_SO_ECCResult;
    }
     ...
     */
    public void setZBAPI_DSS_SO_ECCResult(com.bses2.sap.ws.ZBAPI_DSS_SO_ECCResponseZBAPI_DSS_SO_ECCResult ZBAPI_DSS_SO_ECCResult) {
        this.ZBAPI_DSS_SO_ECCResult = ZBAPI_DSS_SO_ECCResult;
    }

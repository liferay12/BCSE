...
public class ZBAPI_UPDATE_TNOResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_UPDATE_TNOResponseZBAPI_UPDATE_TNOResult ZBAPI_UPDATE_TNOResult;

    public ZBAPI_UPDATE_TNOResponse() {
    }

    public ZBAPI_UPDATE_TNOResponse(
           com.bses2.sap.ws.ZBAPI_UPDATE_TNOResponseZBAPI_UPDATE_TNOResult ZBAPI_UPDATE_TNOResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_UPDATE_TNOResponseZBAPI_UPDATE_TNOResult getZBAPI_UPDATE_TNOResult() {
        return ZBAPI_UPDATE_TNOResult;
    }
     ...
     */
    public void setZBAPI_UPDATE_TNOResult(com.bses2.sap.ws.ZBAPI_UPDATE_TNOResponseZBAPI_UPDATE_TNOResult ZBAPI_UPDATE_TNOResult) {
        this.ZBAPI_UPDATE_TNOResult = ZBAPI_UPDATE_TNOResult;
    }

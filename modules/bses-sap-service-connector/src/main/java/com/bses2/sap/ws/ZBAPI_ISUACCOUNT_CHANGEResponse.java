...
public class ZBAPI_ISUACCOUNT_CHANGEResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_ISUACCOUNT_CHANGEResponseZBAPI_ISUACCOUNT_CHANGEResult ZBAPI_ISUACCOUNT_CHANGEResult;

    public ZBAPI_ISUACCOUNT_CHANGEResponse() {
    }

    public ZBAPI_ISUACCOUNT_CHANGEResponse(
           com.bses2.sap.ws.ZBAPI_ISUACCOUNT_CHANGEResponseZBAPI_ISUACCOUNT_CHANGEResult ZBAPI_ISUACCOUNT_CHANGEResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_ISUACCOUNT_CHANGEResponseZBAPI_ISUACCOUNT_CHANGEResult getZBAPI_ISUACCOUNT_CHANGEResult() {
        return ZBAPI_ISUACCOUNT_CHANGEResult;
    }
     ...
     */
    public void setZBAPI_ISUACCOUNT_CHANGEResult(com.bses2.sap.ws.ZBAPI_ISUACCOUNT_CHANGEResponseZBAPI_ISUACCOUNT_CHANGEResult ZBAPI_ISUACCOUNT_CHANGEResult) {
        this.ZBAPI_ISUACCOUNT_CHANGEResult = ZBAPI_ISUACCOUNT_CHANGEResult;
    }

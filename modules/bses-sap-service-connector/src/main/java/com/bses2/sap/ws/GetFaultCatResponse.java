...
public class GetFaultCatResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.GetFaultCatResponseGetFaultCatResult getFaultCatResult;

    public GetFaultCatResponse() {
    }

    public GetFaultCatResponse(
           com.bses2.sap.ws.GetFaultCatResponseGetFaultCatResult getFaultCatResult) {
     ...
     */
    public com.bses2.sap.ws.GetFaultCatResponseGetFaultCatResult getGetFaultCatResult() {
        return getFaultCatResult;
    }
     ...
     */
    public void setGetFaultCatResult(com.bses2.sap.ws.GetFaultCatResponseGetFaultCatResult getFaultCatResult) {
        this.getFaultCatResult = getFaultCatResult;
    }

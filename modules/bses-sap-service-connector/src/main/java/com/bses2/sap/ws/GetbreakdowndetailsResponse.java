...
public class GetbreakdowndetailsResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.GetbreakdowndetailsResponseGetbreakdowndetailsResult getbreakdowndetailsResult;

    public GetbreakdowndetailsResponse() {
    }

    public GetbreakdowndetailsResponse(
           com.bses2.sap.ws.GetbreakdowndetailsResponseGetbreakdowndetailsResult getbreakdowndetailsResult) {
     ...
     */
    public com.bses2.sap.ws.GetbreakdowndetailsResponseGetbreakdowndetailsResult getGetbreakdowndetailsResult() {
        return getbreakdowndetailsResult;
    }
     ...
     */
    public void setGetbreakdowndetailsResult(com.bses2.sap.ws.GetbreakdowndetailsResponseGetbreakdowndetailsResult getbreakdowndetailsResult) {
        this.getbreakdowndetailsResult = getbreakdowndetailsResult;
    }

...
public class Get_CMS_MISResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.Get_CMS_MISResponseGet_CMS_MISResult get_CMS_MISResult;

    public Get_CMS_MISResponse() {
    }

    public Get_CMS_MISResponse(
           com.bses2.sap.ws.Get_CMS_MISResponseGet_CMS_MISResult get_CMS_MISResult) {
     ...
     */
    public com.bses2.sap.ws.Get_CMS_MISResponseGet_CMS_MISResult getGet_CMS_MISResult() {
        return get_CMS_MISResult;
    }
     ...
     */
    public void setGet_CMS_MISResult(com.bses2.sap.ws.Get_CMS_MISResponseGet_CMS_MISResult get_CMS_MISResult) {
        this.get_CMS_MISResult = get_CMS_MISResult;
    }

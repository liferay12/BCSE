...
public class ZBAPI_CREATESO_POSTResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_CREATESO_POSTResponseZBAPI_CREATESO_POSTResult ZBAPI_CREATESO_POSTResult;

    public ZBAPI_CREATESO_POSTResponse() {
    }

    public ZBAPI_CREATESO_POSTResponse(
           com.bses2.sap.ws.ZBAPI_CREATESO_POSTResponseZBAPI_CREATESO_POSTResult ZBAPI_CREATESO_POSTResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_CREATESO_POSTResponseZBAPI_CREATESO_POSTResult getZBAPI_CREATESO_POSTResult() {
        return ZBAPI_CREATESO_POSTResult;
    }
     ...
     */
    public void setZBAPI_CREATESO_POSTResult(com.bses2.sap.ws.ZBAPI_CREATESO_POSTResponseZBAPI_CREATESO_POSTResult ZBAPI_CREATESO_POSTResult) {
        this.ZBAPI_CREATESO_POSTResult = ZBAPI_CREATESO_POSTResult;
    }

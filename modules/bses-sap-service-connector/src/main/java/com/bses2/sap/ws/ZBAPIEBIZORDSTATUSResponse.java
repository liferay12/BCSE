...
public class ZBAPIEBIZORDSTATUSResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPIEBIZORDSTATUSResponseZBAPIEBIZORDSTATUSResult ZBAPIEBIZORDSTATUSResult;

    public ZBAPIEBIZORDSTATUSResponse() {
    }

    public ZBAPIEBIZORDSTATUSResponse(
           com.bses2.sap.ws.ZBAPIEBIZORDSTATUSResponseZBAPIEBIZORDSTATUSResult ZBAPIEBIZORDSTATUSResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPIEBIZORDSTATUSResponseZBAPIEBIZORDSTATUSResult getZBAPIEBIZORDSTATUSResult() {
        return ZBAPIEBIZORDSTATUSResult;
    }
     ...
     */
    public void setZBAPIEBIZORDSTATUSResult(com.bses2.sap.ws.ZBAPIEBIZORDSTATUSResponseZBAPIEBIZORDSTATUSResult ZBAPIEBIZORDSTATUSResult) {
        this.ZBAPIEBIZORDSTATUSResult = ZBAPIEBIZORDSTATUSResult;
    }

...
public class ZBAPI_FICA_DEMAND_NOTEResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_FICA_DEMAND_NOTEResponseZBAPI_FICA_DEMAND_NOTEResult ZBAPI_FICA_DEMAND_NOTEResult;

    public ZBAPI_FICA_DEMAND_NOTEResponse() {
    }

    public ZBAPI_FICA_DEMAND_NOTEResponse(
           com.bses2.sap.ws.ZBAPI_FICA_DEMAND_NOTEResponseZBAPI_FICA_DEMAND_NOTEResult ZBAPI_FICA_DEMAND_NOTEResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_FICA_DEMAND_NOTEResponseZBAPI_FICA_DEMAND_NOTEResult getZBAPI_FICA_DEMAND_NOTEResult() {
        return ZBAPI_FICA_DEMAND_NOTEResult;
    }
     ...
     */
    public void setZBAPI_FICA_DEMAND_NOTEResult(com.bses2.sap.ws.ZBAPI_FICA_DEMAND_NOTEResponseZBAPI_FICA_DEMAND_NOTEResult ZBAPI_FICA_DEMAND_NOTEResult) {
        this.ZBAPI_FICA_DEMAND_NOTEResult = ZBAPI_FICA_DEMAND_NOTEResult;
    }

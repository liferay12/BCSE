...
public class ZBI_WEBBILL_HISTResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBI_WEBBILL_HISTResponseZBI_WEBBILL_HISTResult ZBI_WEBBILL_HISTResult;

    public ZBI_WEBBILL_HISTResponse() {
    }

    public ZBI_WEBBILL_HISTResponse(
           com.bses2.sap.ws.ZBI_WEBBILL_HISTResponseZBI_WEBBILL_HISTResult ZBI_WEBBILL_HISTResult) {
     ...
     */
    public com.bses2.sap.ws.ZBI_WEBBILL_HISTResponseZBI_WEBBILL_HISTResult getZBI_WEBBILL_HISTResult() {
        return ZBI_WEBBILL_HISTResult;
    }
     ...
     */
    public void setZBI_WEBBILL_HISTResult(com.bses2.sap.ws.ZBI_WEBBILL_HISTResponseZBI_WEBBILL_HISTResult ZBI_WEBBILL_HISTResult) {
        this.ZBI_WEBBILL_HISTResult = ZBI_WEBBILL_HISTResult;
    }

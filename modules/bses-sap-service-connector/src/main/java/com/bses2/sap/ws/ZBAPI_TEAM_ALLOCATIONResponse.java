...
public class ZBAPI_TEAM_ALLOCATIONResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_TEAM_ALLOCATIONResponseZBAPI_TEAM_ALLOCATIONResult ZBAPI_TEAM_ALLOCATIONResult;

    public ZBAPI_TEAM_ALLOCATIONResponse() {
    }

    public ZBAPI_TEAM_ALLOCATIONResponse(
           com.bses2.sap.ws.ZBAPI_TEAM_ALLOCATIONResponseZBAPI_TEAM_ALLOCATIONResult ZBAPI_TEAM_ALLOCATIONResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_TEAM_ALLOCATIONResponseZBAPI_TEAM_ALLOCATIONResult getZBAPI_TEAM_ALLOCATIONResult() {
        return ZBAPI_TEAM_ALLOCATIONResult;
    }
     ...
     */
    public void setZBAPI_TEAM_ALLOCATIONResult(com.bses2.sap.ws.ZBAPI_TEAM_ALLOCATIONResponseZBAPI_TEAM_ALLOCATIONResult ZBAPI_TEAM_ALLOCATIONResult) {
        this.ZBAPI_TEAM_ALLOCATIONResult = ZBAPI_TEAM_ALLOCATIONResult;
    }

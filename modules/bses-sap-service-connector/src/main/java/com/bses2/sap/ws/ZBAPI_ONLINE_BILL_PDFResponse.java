...
public class ZBAPI_ONLINE_BILL_PDFResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_ONLINE_BILL_PDFResponseZBAPI_ONLINE_BILL_PDFResult ZBAPI_ONLINE_BILL_PDFResult;

    public ZBAPI_ONLINE_BILL_PDFResponse() {
    }

    public ZBAPI_ONLINE_BILL_PDFResponse(
           com.bses2.sap.ws.ZBAPI_ONLINE_BILL_PDFResponseZBAPI_ONLINE_BILL_PDFResult ZBAPI_ONLINE_BILL_PDFResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_ONLINE_BILL_PDFResponseZBAPI_ONLINE_BILL_PDFResult getZBAPI_ONLINE_BILL_PDFResult() {
        return ZBAPI_ONLINE_BILL_PDFResult;
    }
     ...
     */
    public void setZBAPI_ONLINE_BILL_PDFResult(com.bses2.sap.ws.ZBAPI_ONLINE_BILL_PDFResponseZBAPI_ONLINE_BILL_PDFResult ZBAPI_ONLINE_BILL_PDFResult) {
        this.ZBAPI_ONLINE_BILL_PDFResult = ZBAPI_ONLINE_BILL_PDFResult;
    }

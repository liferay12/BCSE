...
public class ZBAPI_CALERTResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_CALERTResponseZBAPI_CALERTResult ZBAPI_CALERTResult;

    public ZBAPI_CALERTResponse() {
    }

    public ZBAPI_CALERTResponse(
           com.bses2.sap.ws.ZBAPI_CALERTResponseZBAPI_CALERTResult ZBAPI_CALERTResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_CALERTResponseZBAPI_CALERTResult getZBAPI_CALERTResult() {
        return ZBAPI_CALERTResult;
    }
     ...
     */
    public void setZBAPI_CALERTResult(com.bses2.sap.ws.ZBAPI_CALERTResponseZBAPI_CALERTResult ZBAPI_CALERTResult) {
        this.ZBAPI_CALERTResult = ZBAPI_CALERTResult;
    }

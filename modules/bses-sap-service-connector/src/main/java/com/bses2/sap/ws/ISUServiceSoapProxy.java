...
public class ISUServiceSoapProxy implements com.bses2.sap.ws.ISUServiceSoap {
  private String _endpoint = null;
  private com.bses2.sap.ws.ISUServiceSoap iSUServiceSoap = null;
  ...
  private void _initISUServiceSoapProxy() {
    try {
      iSUServiceSoap = (new com.bses2.sap.ws.ISUServiceLocator()).getISUServiceSoap();
  ...
  public com.bses2.sap.ws.ISUServiceSoap getISUServiceSoap() {
    if (iSUServiceSoap == null)
      _initISUServiceSoapProxy();

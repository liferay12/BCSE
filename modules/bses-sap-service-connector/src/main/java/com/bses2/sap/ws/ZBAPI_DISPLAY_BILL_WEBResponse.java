...
public class ZBAPI_DISPLAY_BILL_WEBResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_DISPLAY_BILL_WEBResponseZBAPI_DISPLAY_BILL_WEBResult ZBAPI_DISPLAY_BILL_WEBResult;

    public ZBAPI_DISPLAY_BILL_WEBResponse() {
    }

    public ZBAPI_DISPLAY_BILL_WEBResponse(
           com.bses2.sap.ws.ZBAPI_DISPLAY_BILL_WEBResponseZBAPI_DISPLAY_BILL_WEBResult ZBAPI_DISPLAY_BILL_WEBResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_DISPLAY_BILL_WEBResponseZBAPI_DISPLAY_BILL_WEBResult getZBAPI_DISPLAY_BILL_WEBResult() {
        return ZBAPI_DISPLAY_BILL_WEBResult;
    }
     ...
     */
    public void setZBAPI_DISPLAY_BILL_WEBResult(com.bses2.sap.ws.ZBAPI_DISPLAY_BILL_WEBResponseZBAPI_DISPLAY_BILL_WEBResult ZBAPI_DISPLAY_BILL_WEBResult) {
        this.ZBAPI_DISPLAY_BILL_WEBResult = ZBAPI_DISPLAY_BILL_WEBResult;
    }

...
public class Z_BAPI_IVRSResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.Z_BAPI_IVRSResponseZ_BAPI_IVRSResult z_BAPI_IVRSResult;

    public Z_BAPI_IVRSResponse() {
    }

    public Z_BAPI_IVRSResponse(
           com.bses2.sap.ws.Z_BAPI_IVRSResponseZ_BAPI_IVRSResult z_BAPI_IVRSResult) {
     ...
     */
    public com.bses2.sap.ws.Z_BAPI_IVRSResponseZ_BAPI_IVRSResult getZ_BAPI_IVRSResult() {
        return z_BAPI_IVRSResult;
    }
     ...
     */
    public void setZ_BAPI_IVRSResult(com.bses2.sap.ws.Z_BAPI_IVRSResponseZ_BAPI_IVRSResult z_BAPI_IVRSResult) {
        this.z_BAPI_IVRSResult = z_BAPI_IVRSResult;
    }

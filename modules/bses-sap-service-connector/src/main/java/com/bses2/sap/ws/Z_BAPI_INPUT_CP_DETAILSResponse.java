...
public class Z_BAPI_INPUT_CP_DETAILSResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.Z_BAPI_INPUT_CP_DETAILSResponseZ_BAPI_INPUT_CP_DETAILSResult z_BAPI_INPUT_CP_DETAILSResult;

    public Z_BAPI_INPUT_CP_DETAILSResponse() {
    }

    public Z_BAPI_INPUT_CP_DETAILSResponse(
           com.bses2.sap.ws.Z_BAPI_INPUT_CP_DETAILSResponseZ_BAPI_INPUT_CP_DETAILSResult z_BAPI_INPUT_CP_DETAILSResult) {
     ...
     */
    public com.bses2.sap.ws.Z_BAPI_INPUT_CP_DETAILSResponseZ_BAPI_INPUT_CP_DETAILSResult getZ_BAPI_INPUT_CP_DETAILSResult() {
        return z_BAPI_INPUT_CP_DETAILSResult;
    }
     ...
     */
    public void setZ_BAPI_INPUT_CP_DETAILSResult(com.bses2.sap.ws.Z_BAPI_INPUT_CP_DETAILSResponseZ_BAPI_INPUT_CP_DETAILSResult z_BAPI_INPUT_CP_DETAILSResult) {
        this.z_BAPI_INPUT_CP_DETAILSResult = z_BAPI_INPUT_CP_DETAILSResult;
    }

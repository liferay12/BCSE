...
public class GetbreakdownbackfeedlistResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.GetbreakdownbackfeedlistResponseGetbreakdownbackfeedlistResult getbreakdownbackfeedlistResult;

    public GetbreakdownbackfeedlistResponse() {
    }

    public GetbreakdownbackfeedlistResponse(
           com.bses2.sap.ws.GetbreakdownbackfeedlistResponseGetbreakdownbackfeedlistResult getbreakdownbackfeedlistResult) {
     ...
     */
    public com.bses2.sap.ws.GetbreakdownbackfeedlistResponseGetbreakdownbackfeedlistResult getGetbreakdownbackfeedlistResult() {
        return getbreakdownbackfeedlistResult;
    }
     ...
     */
    public void setGetbreakdownbackfeedlistResult(com.bses2.sap.ws.GetbreakdownbackfeedlistResponseGetbreakdownbackfeedlistResult getbreakdownbackfeedlistResult) {
        this.getbreakdownbackfeedlistResult = getbreakdownbackfeedlistResult;
    }

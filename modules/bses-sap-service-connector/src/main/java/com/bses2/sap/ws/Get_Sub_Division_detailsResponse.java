...
public class Get_Sub_Division_detailsResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.Get_Sub_Division_detailsResponseGet_Sub_Division_detailsResult get_Sub_Division_detailsResult;

    public Get_Sub_Division_detailsResponse() {
    }

    public Get_Sub_Division_detailsResponse(
           com.bses2.sap.ws.Get_Sub_Division_detailsResponseGet_Sub_Division_detailsResult get_Sub_Division_detailsResult) {
     ...
     */
    public com.bses2.sap.ws.Get_Sub_Division_detailsResponseGet_Sub_Division_detailsResult getGet_Sub_Division_detailsResult() {
        return get_Sub_Division_detailsResult;
    }
     ...
     */
    public void setGet_Sub_Division_detailsResult(com.bses2.sap.ws.Get_Sub_Division_detailsResponseGet_Sub_Division_detailsResult get_Sub_Division_detailsResult) {
        this.get_Sub_Division_detailsResult = get_Sub_Division_detailsResult;
    }

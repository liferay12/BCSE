...
public class ZBAPI_EDISTRICTResponse  implements java.io.Serializable {
    private com.bses2.sap.ws.ZBAPI_EDISTRICTResponseZBAPI_EDISTRICTResult ZBAPI_EDISTRICTResult;

    public ZBAPI_EDISTRICTResponse() {
    }

    public ZBAPI_EDISTRICTResponse(
           com.bses2.sap.ws.ZBAPI_EDISTRICTResponseZBAPI_EDISTRICTResult ZBAPI_EDISTRICTResult) {
     ...
     */
    public com.bses2.sap.ws.ZBAPI_EDISTRICTResponseZBAPI_EDISTRICTResult getZBAPI_EDISTRICTResult() {
        return ZBAPI_EDISTRICTResult;
    }
     ...
     */
    public void setZBAPI_EDISTRICTResult(com.bses2.sap.ws.ZBAPI_EDISTRICTResponseZBAPI_EDISTRICTResult ZBAPI_EDISTRICTResult) {
        this.ZBAPI_EDISTRICTResult = ZBAPI_EDISTRICTResult;
    }

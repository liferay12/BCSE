...
import com.bses.connection2.service.RequestNumberSeqService;
import com.bses.connection2.service.RequestNumberSeqServiceUtil;
...
/**
 * Provides the base implementation for the request number seq remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.bses.connection2.service.impl.RequestNumberSeqServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.bses.connection2.service.impl.RequestNumberSeqServiceImpl
 * @generated
 */
public abstract class RequestNumberSeqServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, RequestNumberSeqService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RequestNumberSeqService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RequestNumberSeqServiceUtil</code>.
	 */
	 ...
	 */
	public RequestNumberSeqService getRequestNumberSeqService() {
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(requestNumberSeqService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RequestNumberSeqService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = RequestNumberSeqServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, requestNumberSeqService);
		}
	...
	@BeanReference(type = RequestNumberSeqService.class)
	protected RequestNumberSeqService requestNumberSeqService;

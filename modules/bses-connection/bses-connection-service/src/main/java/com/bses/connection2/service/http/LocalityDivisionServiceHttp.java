...
public class LocalityDivisionServiceHttp {
	...
	public static com.liferay.portal.kernel.json.JSONArray
		getAvailableDivisionSlots(
			HttpPrincipal httpPrincipal, java.util.Date appointmentDate) {

		try {
			MethodKey methodKey = new MethodKey(
				LocalityDivisionServiceUtil.class, "getAvailableDivisionSlots",
				_getAvailableDivisionSlotsParameterTypes1);
	...
	private static final Class<?>[] _getAvailableDivisionSlotsParameterTypes1 =

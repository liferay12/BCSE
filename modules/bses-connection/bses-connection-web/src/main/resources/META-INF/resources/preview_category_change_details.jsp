...
%>
	...
	<%
		...
		String oldTariffCategory = MasterData.getTariffCategoryValue(oldEntity.getTariffCategory());
		String newTariffCategory = MasterData.getTariffCategoryValue(connectionRequest.getTariffCategory());
	...
	<div class="container-fluid mt-2" style="border:1px solid #ced4da;">
		...
		<div class="row">
			<div class="col-md-6 p-4 data-border">
				<label>Existing category of the connection:</label>
			</div>
			<div class="col-md-6 p-4 data-border" >
				<label><%=oldTariffCategory %></label>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 p-4 data-border">
				<label>Change of category desired:</label>
			</div>
			<div class="col-md-6 p-4 data-border" >
				<label><%=newTariffCategory %></label>
			</div>
		</div>
	</div>